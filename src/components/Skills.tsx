...
const categoryDefinitions: {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'CRM Systems', tooltip: 'Customer workflow tools' },
    ],
  },
];
...
const findSkill = (name: string): Skill | null =>
  allSkills.find((s) => s.name === name) || null;
      ...
      <div className="group">
        <div
          className="
            ...
            dark:hover:bg-[#1a2231]
          "
          aria-describedby={`tooltip-${name.replace(/\s+/g, '-')}`}
        >
          <Icon
            className="
              text-3xl text-neutral-700 dark:text-neutral-300 
        ...
        {tooltip && (
          <div
            ...
            className="
              ...
              bottom-[calc(100%+12px)] opacity-0 group-hover:opacity-100 
              transition-all duration-200 z-50
            "
          >
            <div className="rounded-lg px-3 py-2 text-sm bg-neutral-900 text-white shadow-xl">
              {tooltip}
            </div>
          </div>
        )}
    ...
    >
      <div className="max-w-[1450px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.p
          ...
          className="text-base text-neutral-600 dark:text-neutral-300 max-w-2xl mb-10"
        >
